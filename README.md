...
- **Thuật toán MinHash + LSH**: Phát hiện độ tương đồng nhanh chóng (~50ms)
- **Truy cập Công khai**: Kiểm tra đạo văn trực tiếp không cần đăng nhập (Public Route)
- **Hệ thống Xác thực Thực tế**: Đăng ký/Đăng nhập và quản lý lịch sử dựa trên database PostgreSQL
- **Xử lý tiếng Việt**: Tối ưu hóa văn bản tiếng Việt với `underthesea`
- **Khả năng mở rộng**: Tự động hóa nạp dữ liệu Wikipedia vào Corpus qua script
- **Độ chính xác cao**: Phát hiện bản sao gần giống với cấu hình Shingling tối ưu
